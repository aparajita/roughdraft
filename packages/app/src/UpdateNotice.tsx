...
export function UpdateNotice({ updateStatus }: UpdateNoticeProps) {
  ...
  return (
    <div
      className="rounded-2xl border border-amber-200 dark:border-amber-700 bg-amber-50/95 dark:bg-amber-950/95 p-4 text-slate-900 dark:text-slate-100 shadow-lg backdrop-blur"
