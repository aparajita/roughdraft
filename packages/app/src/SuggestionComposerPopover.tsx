      ...
      <PopoverPrimitive.Portal>
        ...
        >
          ...
          >
            ...
            <PopoverPrimitive.Arrow className="z-50 size-2.5 rotate-45 rounded-[2px] border-t border-l border-[#DCD6CC] dark:border-slate-700 bg-[#FFFDFC] dark:bg-slate-900 data-[side=right]:left-0 data-[side=right]:-translate-x-1/2 data-[side=left]:right-0 data-[side=left]:translate-x-1/2" />
          </PopoverPrimitive.Popup>
        </PopoverPrimitive.Positioner>
      </PopoverPrimitive.Portal>
    </PopoverPrimitive.Root>
